        ...
        .then((res) => {
          if (res.status === 200) {
            ...
            if (userType === "TempSocial") {
              window.location.replace(`http://extraordinary-melba-a931eb.netlify.app/completeProfile`);
            ...
            if (userType === "Candidate") {
              if (
                ...
                window.location.replace(`http://extraordinary-melba-a931eb.netlify.app/uploadResume`);
              } else {
                if (Redirect !== null) {
                  window.location.replace(`http://extraordinary-melba-a931eb.netlify.app${Redirect}`);
                }
                window.location.replace(`http://extraordinary-melba-a931eb.netlify.app/`);
              }
              // navigate("/resume", { replace: false });
            } else {
              window.location.replace(`http://extraordinary-melba-a931eb.netlify.app/Employer/Dashboard`);
              // navigate("/", { replace: false });
            }
          }
        });
