...
const CandiFullProfileView = () => {
  ...
  const recroot = `http://preprod.recroot.au/api/downloadResume?resume=${resume?.resume?.replace(
    /\\/g,
    "/"
  )}`;
  ...
  const saveNote = () => {
    axios
      .post(
        `http://preprod.recroot.au/api/postNote/${appdata._id}`,
        { notes: notes },
                                  ...
                                  <IconButton
                                    onClick={async () => {
                                      const res = await fetch(
                                        `http://preprod.recroot.au/api/downloadResume?resume=${cert?.certificatepath?.replace(
                                          /\\/g,
                                          "/"
                                        )}`
                                      );
